		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				grabItem: function(e) {
					...
					list.draggedItem.addClass("dragging");
          list.draggedItem.closest("ol").addClass("dragging");
          list.draggedItem.closest("div").addClass("dragging");
				...
				dropItem: function() {
					...
					list.draggedItem.removeClass("dragging");
          list.draggedItem.closest("ol").removeClass("dragging");
          list.draggedItem.closest("div").removeClass("dragging");
